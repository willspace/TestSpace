...
NEJ.define([
    ...
    _pro.__init = function(_options){
        ...
        this.__mobileInput = new _mi({data:{placeholder:"请输入新手机号码"}});
    ...
    _pro.__onRequestSms = function(_type){
        if(_type == 0){
            ...
            var _url = '/web/mobchgoff/send_sms_checkcode';
            var _data = {
    ...
    _pro.__doNext = function(){
        ...
        if (this.__mobileInput.data.state==1 && this.__smsInput.data.state==1 ){
            //// doNext
            var _url = '/web/mobchgoff/apply_mobchg';
            var _data = {
                newmobile     : this.__mobileInput.data.value,
