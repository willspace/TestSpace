...
define([
  ...
  'text!./notify.html'
], function(_e,_v,_u,_base,_tmp){

  var Notify = _base.extend({
    template:_tmp,
    //默认时间 
    duration: 5000,
  ...
  // 单例, 直接初始化
  _$notify = new Notify({}).$inject("#b-toast");

  /**
   * 使用:
   *    _$notify.notify(msg) 开始进度条
   *    _$notify.show(msg)   显示信息
   *    _$notify.showError(msg) 显示错误 , show的简便接口
   */
